  ...
  return (
    <div className="h-screen grid grid-rows-[60px_1fr]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2">
        ...
        <h1 className="font-extrabold text-7xl md:text-9xl danger">404!</h1>
        <h1 className="font-extrabold text-2xl md:text-4xl warning">Page Not Found</h1>
        <p className="text-gray-700 font-bold py-2! w-xs">Oops! the page you are looking for doesn't exist or has been removed.</p>
        <div className="grid grid-cols-2 gap-4 my-10!">
            <Link to={"/"} className="text-black btn">Go to Dashboard</Link>
            <Link to={"/"} className="text-black sec-btn">Go Back</Link>
        </div>
        </div>
